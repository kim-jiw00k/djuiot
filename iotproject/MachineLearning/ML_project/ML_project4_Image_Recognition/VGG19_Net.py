...
model = keras.Sequential(name="VGG19_NET")
input_layer = keras.Input(shape=(224, 224, 3), name='Input_Image')
...
import cv2
image1 = cv2.imread(filename='squirrel.jpg')
image1 = cv2.resize(image1, (224, 224))
print(image1.shape)
import numpy as np
image1 = image1[np.newaxis, :]  # 배치 차원 추가
print(image1.shape)
...
print(f"예상 되는 그림은 : {classes[finding_key]}")

from matplotlib import pyplot as plt
image = cv2.imread('squirrel.jpg')
image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
plt.imshow(X=image)
plt.title(classes[finding_key])
plt.show()